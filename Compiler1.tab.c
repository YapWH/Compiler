...
nodeType* eigen (nodeType *_mat) {
    nodeType* M_array_eigen_vec = NULL;
    if (_mat->mat.col == _mat->mat.row) {
        M_array_eigen_vec = malloc(sizeof(nodeType *)*2); 
        enum{val=0, vec=1};
